...
class SecondIprSeeder extends Seeder
{
    /**
    ...
    public function run()
    {
        $collection = (new FastExcel)->import(storage_path('/app/iprs/2/iprs.xlsx'));
        ...
        for ($i = 0; $i < 5; $i ++ ){
            $collection_schedule = (new FastExcel)->import(storage_path('/app/iprs/2/'.$arr[$i]));
