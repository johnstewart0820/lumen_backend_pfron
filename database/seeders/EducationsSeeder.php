...
class EducationsSeeder extends Seeder
{
    ...
    public function run()
    {
        $items = [
            ...
            ['id' => 2, 'name' => 'Gimnajalne (ISCED 2)'],
            ['id' => 3, 'name' => 'średnie zawodowe (technik) (ISCED 3)'],
            ['id' => 4, 'name' => 'Pomaturalne (ISCED 4)'],
            ['id' => 5, 'name' => 'wyźsze magisterskie (mgr lub równorzędne) (ISCED 7)'],
            ['id' => 6, 'name' => 'Podstawowe (ISCED 1)'],
            ['id' => 7, 'name' => 'zasadnicze zawodowe(ISCED 3)'],
            ['id' => 8, 'name' => 'Licealne (ISCED 3)'],
            ['id' => 9, 'name' => 'wyźsze zawodowe (lic., inź. lub równorzędne) (ISCED 5-6)'],
            ['id' => 10, 'name' => 'wyźszy stopień lub tytuł naukowy (dr, prof.) (ISCED 8)'],
        ];
