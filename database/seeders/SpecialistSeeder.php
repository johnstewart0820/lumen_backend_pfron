...
class SpecialistSeeder extends Seeder
{
    ...
    public function run()
    {
        $items = [
            ...
            ["id" => 84, "name" =>"Małgorzata Czapla", "qualification_point" =>3,"specialty" => 1,"status" => 1],
            ["id" => 85, "name" =>"Aneta Perzyńska-Starkiewicz", "qualification_point" =>18,"specialty" => 1,"status" => 1],
            ["id" => 86, "name" =>"Dawid Kłapkowski", "qualification_point" =>2,"specialty" => 1,"status" => 1],
            ["id" => 87, "name" =>"Aleksander Gryszczenia", "qualification_point" =>23,"specialty" => 1,"status" => 1],
            ["id" => 88, "name" =>"Elżbieta Stachera", "qualification_point" =>23,"specialty" => 1,"status" => 1],
            ["id" => 89, "name" =>"Aleksandra Kaczmarczyk", "qualification_point" =>38,"specialty" => 1,"status" => 1],
            ["id" => 90, "name" =>"Iwona Bernaciak", "qualification_point" =>6,"specialty" => 1,"status" => 1],
        ];
